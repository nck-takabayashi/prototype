            ...
            <v-flex xs12 sm8 lg4 md5>
                <v-card class="login-card">
                    ...
                    <v-form v-else ref="form" v-model="valid" lazy-validation>
                        <v-container>
                            <v-text-field v-model="credentials.username" :counter="12" label="ユーザーID" maxlength="12" required/>
                            <v-text-field type="password" v-model="credentials.password" :counter="12" label="パスワード" maxlength="12" required/>
                        </v-container>
